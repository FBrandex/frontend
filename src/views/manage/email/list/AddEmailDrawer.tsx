...
// ** Actions Imports
import { addEmail } from 'src/store/manage/email'

// ** Types Imports
import { AppDispatch } from 'src/store'

interface SidebarAddEmailType {
  open: boolean
  toggle: () => void
}
...
const SidebarAddEmail = (props: SidebarAddEmailType) => {
  // ** Props
  ...
  return (
    ...
    >
      <Header>
        <Typography variant='h6'>Add Email</Typography>
...
export default SidebarAddEmail
