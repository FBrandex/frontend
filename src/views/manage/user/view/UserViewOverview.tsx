          ...
          <Timeline>
            <TimelineItem>
              ...
              <TimelineContent>
                ...
                >
                  <Typography sx={{ mr: 2, mb: 1, fontWeight: 600 }}>12 Orders have been paid</Typography>
                  <Typography variant='body2' sx={{ color: 'text.disabled' }}>
                    12 min ago
                  </Typography>
                </Box>
                <Typography variant='body2'>Orders have been paid to the company</Typography>
                <Box sx={{ mt: 2, display: 'flex' }}>
                  <Box sx={{ width: 28, height: 'auto' }}>
                    <img alt='order.pdf' src='/images/icons/file-icons/pdf-2.png' />
                  </Box>
            ...
            <TimelineItem>
              ...
              <TimelineContent>
                ...
                >
                  <Typography sx={{ mr: 2, mb: 1, fontWeight: 600 }}>Create orders for client</Typography>
                  <Typography variant='body2' sx={{ color: 'text.disabled' }}>
                    5 days ago
                  </Typography>
                </Box>
