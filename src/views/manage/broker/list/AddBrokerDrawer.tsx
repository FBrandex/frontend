...
// ** Actions Imports
import { addBroker } from 'src/store/manage/broker'

// ** Types Imports
import { AppDispatch } from 'src/store'

interface SidebarAddBrokerType {
  open: boolean
  toggle: () => void
}
...
const SidebarAddBroker = (props: SidebarAddBrokerType) => {
  // ** Props
  ...
  const onSubmit = (data: BrokerData) => {
    dispatch(addBroker({ ...data }))
    toggle()
    reset()
  }
...
export default SidebarAddBroker
